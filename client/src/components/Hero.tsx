...
function Hero() {
  return (
    <div className={`bg-[url("/src/assets/heroImage.png")] bg-no-repeat bg-cover bg-center min-h-[70vh] w-full text-white flex flex-col px-6 md:px-16 lg:px-24 xl:px-32 h-screen justify-center items-start`}>
