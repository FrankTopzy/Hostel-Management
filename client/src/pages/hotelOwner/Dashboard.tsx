    ...
    <div>
      ...
      <div className='flex gap-4 my-8'>
        ...
        <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
          <img src={assets.totalBookingIcon} alt="total" className='max-sm:hidden h-10'/>
        ...
        {/* ----- Total Revenue ------------- */}
        <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
          <img src={assets.totalRevenueIcon} alt="total" className='max-sm:hidden h-10'/>
          ...
          <tbody>
            {dashboardData.bookings.map((item, index) => (
              <tr key={index}>
                ...
                <td className='py-3 px-3 text-gray-700 border-t border-gray-300 flex text-center'>
